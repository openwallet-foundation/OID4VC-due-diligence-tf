...
- Creation of a documentation that 
    1. defines the necessary components and endpoints for the implementation of OID4VC specifications (potentially based on profiles of OID4VC)
    1. lists the requirements of interested implementers (e.g. features & platforms)
    1. reports the existing implementations (e.g. detailed feature set & platforms)
